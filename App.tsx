...
// TODO: 請將您的 Google Email 加入此陣列以取得管理員權限
const ADMIN_EMAILS = [
          ...
          <div key={item.id} className="flex gap-4 group">
            ...
            <div className="flex-1 pb-6">
              <div 
                ...
                className={`bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex gap-4 items-start transition-transform duration-200 relative ${
                  isAdmin 
...
const WishlistView = () => {
  ...
  return (
    <div className="px-6 pt-4 pb-24 h-full flex flex-col">
      ...
      <form onSubmit={handleAddWish} className="mt-4 flex gap-2">
        <input
          ...
          placeholder="你想去哪裡？"
          className="flex-1 px-4 py-3 rounded-xl border-none shadow-sm ring-1 ring-slate-200 focus:ring-2 focus:ring-blue-400 outline-none text-slate-700"
        />
        <button 
          type="submit"
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl shadow-2xl w-full max-w-sm">
        ...
        <p className="text-blue-100 mb-8 font-medium">Okinawa Family Trip 2024</p>
    ...
    <div className="bg-gradient-to-r from-cyan-500 to-blue-500 pt-12 pb-8 px-6 rounded-b-[2.5rem] shadow-xl shadow-blue-100 relative z-20">
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <p className="text-cyan-100 font-medium">2024 家族旅遊</p>
        </div>
        <div 
